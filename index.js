...
app.get('/usuario/:id', Usuario.buscarPorId)
app.get('/usuario/:nome', Usuario.buscarPorNome)
...
app.get('/produto/:id', Produto.buscarPorId)
app.get('/produto/:nome', Produto.buscarPorNome)
